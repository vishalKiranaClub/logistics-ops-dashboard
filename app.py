...
SELLERS=sorted([
"swastiks","sapphire_dry_nuts","vrd_masale","bolas","hugs","candyfun","bakemate",
"zoff_foods","suruchi_spices","kesarco","chuk_de","somnath","go_desi","z_magnetism",
"sugandh","kirana_bazaar","farmkin","archita","charliee","sanjeevani","meera_foods",
"tata","nutraj","annai","apsara_tea","pansari","chaivik","cookme","soothe",
"sarkar_spices","upl","mangalam","savour","daylight_fargo_manpasand","maharani",
"tattvam_luxury_incense","vimaan","kc_punji_rewards","kiranaclub_loyalty_rewards",
"mantra","harnik","rsb_super_stockist","hansha","hans","parimal","gongloo","yumms",
"karnavati_tea_company","blg","derby","continental_coffee","broomify","milan_supari",
"dnv","pickwick","famis_spices","desik","ruby","chotiwale","mona","klaw","kalbavi","rasna"
])
...
with st.form("entry_form"):
    ...
    with c1:
        orders_pending_packing=st.number_input("Orders Pending for Packing",0)
        orders_ready_dispatch=st.number_input("Orders Ready for Dispatch",0)

    with c2:
        orders_packed=st.number_input("Orders Packed",0)
        orders_picked_up=st.number_input("Orders Picked Up",0)

    with c3:
        orders_not_packed_on_time=st.number_input("Orders Not Packed On Time",0)

    backlog_previous_day=st.number_input("Backlog from Previous Day",0)
    ...
    with fc2:
        orders_impacted=st.number_input("Orders Impacted",0)
